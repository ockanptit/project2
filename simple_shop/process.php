...
/**
 * check $_post có tồn tại tức là có dữ liệu được gửi đi đồng thời
 *  !empty tức là nó sẽ có dữ liệu được gửi liệu
 */
            ...
            case 'add':
                if (isset($_POST['quantity'])&& isset($_POST['product_id'])){
                    ...
                    if( isset($_SESSION['cart_item'])&&!empty($_SESSION['cart_item'])){
                         ...
                         * tức là lúc này giỏ hàng k có dữ liệu
                         */
...
header("Location: http://example.com/myOtherPage.php/index.php");
die();